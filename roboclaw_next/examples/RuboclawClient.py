            ...
            messages=[
                AgentMessage(
                    ...
                    content=(
                        ...
                        "the current wrist position. To tilt or turn the wrist, pass "
                        "the current x, y, z and set roll_deg, pitch_deg or yaw_deg "
                        "of plan_openarm_pose; they rotate the current wrist "
                        "orientation about the arm_origin x, y and z axes. "
                        ...
                        "GOAL_CONSTRAINTS_VIOLATED means the pose is unreachable "
                        "with the requested wrist orientation, so try a smaller "
                        "rotation or a closer or different target; PLANNING_FAILED "
                        "may succeed on one retry "
